...
$programName = 'vdb_disable_archivelog.ps1'
...
######### VDB Disable Archive Log ######

log "Disable Archive log for VDB, $oraUnq STARTED"

shutdown "immediate"

start_mount_exclusive_restrict

vdb_disable_archivelog
...
log "Disable Archive log for VDB, $oraUnq FINISHED"
